  ...
  <div class="bg">
    <div class="container">
	  ...
	  ?>
		...
		<input type="text" name="searchbox" placeholder="Search Books..." value=""/>
...
$test_query = "select * from inventory where((item_name LIKE '%$search%')or(item_description LIKE '%$search%')) AND (item_group=1001)";
