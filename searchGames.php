...
<html>
  ...
  <div class="bg">
    <div class="container">
      ...
      <li class="top"><a class="nav" href="index.php">Home</a></li>
       <?php
	  if($loggedin == "0"){
	  ...
	  ?>
		...
		<form  action="searchGames.php" method="GET">
		<input type="text" name="searchbox" placeholder="Search Games..." value=""/>
...
$test_query = "select * from inventory where((item_name LIKE '%$search%')or(item_description LIKE '%$search%')) AND (item_group=1003)";
