  ...
  <div class="bg">
    <div class="container">
	  ...
	  ?>
		...
		<form  action="searchDVDs.php" method="GET">
		<input type="text" name="searchbox" placeholder="Search DVDs..." value=""/>
...
$test_query = "select * from inventory where((item_name LIKE '%$search%')or(item_description LIKE '%$search%')) AND (item_group=1004)";
